...
`*Alternatively, you can download nadekobot from` [Releases Alt][Releases Alt] `and extract the zip yourself. 
...
[Releases]: https://github.com/Kwoth/NadekoUpdater/releases
[Releases Alt]: https://github.com/Kwoth/NadekoBot/releases
