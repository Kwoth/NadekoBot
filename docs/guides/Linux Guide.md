...
`cd ~/NadekoBot/discord.net && dotnet restore -s https://dotnet.myget.org/F/dotnet-core/api/v3/index.json && dotnet restore && cd ~/NadekoBot/src/NadekoBot/ && dotnet restore && dotnet build --configuration Release`
...
**13)**
`cd NadekoBot/src/NadekoBot/ && dotnet run --configuration Release`
