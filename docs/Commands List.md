...
`.antispam` | Stops people from repeating same message X times in a row. You can specify to either mute, kick or ban the offenders. Max message count is 10. Add a time (in seconds) at the end to use a timed mute. **Requires Administrator server permission.** | `.antispam 3 Mute 60` or `.antispam 4 Kick` or `.antispam 6 Ban`
