...
{
    class CustomReactionCommands : DiscordCommand
    {
        public CustomReactionCommands(DiscordModule module) : base(module)
        {
        }

        internal override void Init(CommandGroupBuilder cgb)
        {
            cgb.CreateCommand(Module.Prefix  + "addcustomreaction")
               .Alias(Module.Prefix + "acr")
               .Description($"Add a custom reaction. **Owner Only!**\n**Usage**: {Module.Prefix}acr \"hello\" I love saying hello to %user%")
               ...
               .Do(async e =>
               {
                   ...
                   {
                       await e.Channel.SendMessage($"Incorrect command usage. See -h {Module.Prefix}acr for correct formatting").ConfigureAwait(false);
                       return;
                   }
                   try
                   {
            ...
            cgb.CreateCommand(Module.Prefix + "listcustomreactions")
            .Alias(Module.Prefix + "lcr")
            ...
            cgb.CreateCommand(Module.Prefix + "deletecustomreaction")
            .Alias(Module.Prefix + "dcr")
