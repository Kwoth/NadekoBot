...
👤`{e.User?.ToString() ?? ("NULL")}`
        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            ...
            cgb.CreateCommand(Module.Prefix + "spmom")
                .Description($"Toggles whether mentions of other offline users on your server will send a pm to them.| `{Module.Prefix}spmom`")
            ...
            cgb.CreateCommand(Module.Prefix + "logserver")
                  .Description($"Toggles logging in this channel. Logs every message sent/deleted/edited on the server. **Bot Owner Only!**| `{Module.Prefix}logserver`")
            ...
            cgb.CreateCommand(Prefix + "logignore")
                .Description($"Toggles whether the {Prefix}logserver command ignores this channel. Useful if you have hidden admin channel and public log channel.| `{Module.Prefix}logignore`")
                .AddCheck(SimpleCheckers.OwnerOnly())
                .AddCheck(SimpleCheckers.ManageServer())
                .Do(async e =>
                {
            ...
            cgb.CreateCommand(Module.Prefix + "userpresence")
                  .Description($"Starts logging to this channel when someone from the server goes online/offline/idle.| `{Module.Prefix}userprescence`")
                  .AddCheck(SimpleCheckers.ManageServer())
                  .Do(async e =>
                  {
            ...
            cgb.CreateCommand(Module.Prefix + "voicepresence")
                  .Description($"Toggles logging to this channel whenever someone joins or leaves a voice channel you are in right now.| `{Module.Prefix}voicepresence`")
