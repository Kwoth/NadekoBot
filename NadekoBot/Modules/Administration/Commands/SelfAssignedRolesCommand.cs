        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            cgb.CreateCommand(Module.Prefix + "asar")
                .Description("Adds a role, or list of roles separated by whitespace" +
                             $"(use quotations for multiword roles) to the list of self-assignable roles. | `{Module.Prefix}asar Gamer`")
            ...
            cgb.CreateCommand(Module.Prefix + "rsar")
                .Description($"Removes a specified role from the list of self-assignable roles. | `{Module.Prefix}rsar Gamer`")
            ...
            cgb.CreateCommand(Module.Prefix + "lsar")
                .Description($"Lists all self-assignable roles.| `{Module.Prefix}lsar`")
                .Parameter("roles", ParameterType.Multiple)
                .Do(async e =>
                {
                    var config = SpecificConfigurations.Default.Of(e.Server.Id);
