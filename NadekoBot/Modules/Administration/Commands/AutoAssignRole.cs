    ...
    class AutoAssignRole : DiscordCommand
    {
        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            cgb.CreateCommand(Module.Prefix + "autoassignrole")
                ...
                .Description($"Automaticaly assigns a specified role to every user who joins the server. Type `{Module.Prefix}aar` to disable, `{Module.Prefix}aar Role Name` to enable")
