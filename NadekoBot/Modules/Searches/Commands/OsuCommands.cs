    ...
    internal class OsuCommands : DiscordCommand
    {
        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            cgb.CreateCommand(Module.Prefix + "osu")
                  .Description($"Shows osu stats for a player. | `{Module.Prefix}osu Name` or `{Module.Prefix}osu Name taiko`")
            ...
            cgb.CreateCommand(Module.Prefix + "osu b")
                .Description($"Shows information about an osu beatmap. |`{Module.Prefix}osu b` https://osu.ppy.sh/s/127712")
            ...
            cgb.CreateCommand(Module.Prefix + "osu top5")
                .Description($"Displays a user's top 5 plays.  |`{Module.Prefix}osu top5 Name`")
                .Parameter("usr", ParameterType.Required)
                .Parameter("mode", ParameterType.Unparsed)
                .Do(async e =>
                {
