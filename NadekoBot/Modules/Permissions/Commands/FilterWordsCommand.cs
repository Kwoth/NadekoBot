        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            cgb.CreateCommand(Module.Prefix + "chnlfilterwords")
                ...
                .Description("Enables or disables automatic deleting of messages containing banned words on the channel." +
                             ...
                             $" | `{Module.Prefix}cfw enable #general-chat`")
                .Parameter("bool")
            ...
            cgb.CreateCommand(Module.Prefix + "srvrfilterwords")
                ...
                .Description($"Enables or disables automatic deleting of messages containing forbidden words on the server. | `{Module.Prefix}sfw disable`")
                .Parameter("bool")
                .Do(async e =>
                {
                    try
