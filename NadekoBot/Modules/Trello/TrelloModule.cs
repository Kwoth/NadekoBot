...
namespace Uni.Modules.Trello
{
    internal class TrelloModule : DiscordModule
    {
        private readonly Timer t = new Timer { Interval = 2000 };
        public override string Prefix { get; } = Uni.Config.CommandPrefixes.Trello;
        ...
        public override void Install(ModuleManager manager)
        {
            ...
            TrelloAuthorization.Default.AppKey = Uni.Creds.TrelloAppKey;
            ...
            manager.CreateCommands("trello ", cgb =>
            {
                ...
                cgb.CreateCommand("join")
                    ...
                    .Do(async e =>
                    {
                        if (!Uni.IsOwner(e.User.Id) || Uni.IsBot) return;
                        try
                        {
